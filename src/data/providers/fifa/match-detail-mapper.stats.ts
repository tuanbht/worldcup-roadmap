import type { MatchEvent, MatchEventKind, TeamStats, WinProbability } from '@/domain/types';
...
/**
 * Events assembly + derived stats / win-probability for the FIFA match-detail
 * mapper. Pure helpers extracted from `mapFifaMatchDetail` so the orchestrator
 * stays a thin composition; behavior is byte-for-byte identical to the inline
 * blocks they replace.
 */
